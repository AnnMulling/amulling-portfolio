  ...
  return <Html>
    ...
    <Tailwind>
        <Body className="bg-gray-100 text-black">
            <Container>
                <Section className="bg-white borderBlack mh-10 px-10 py-4 rounded-md">
                    <Heading className="leading-tight">Received the following message from the contact form</Heading>
